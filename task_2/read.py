...
def populate_index_from_csv(csv_file_path, es):
    index_name = os.path.basename("C:\\Users\\User\\AinurKurakbaeva\\DataAnalytics\\inf_428_hw_1\\task_2\\test_case_data").replace('.csv', '')
    actions = []
...
def populate_index_from_directory(directory_path, es):
    for filename in os.listdir(directory_path):
        if filename.endswith('.csv'):
            ...
            print(f"Processing file: {C:\\Users\\User\\AinurKurakbaeva\\DataAnalytics\\inf_428_hw_1\\task_2\\test_case_data}")
            populate_index_from_csv("C:\\Users\\User\\AinurKurakbaeva\\DataAnalytics\\inf_428_hw_1\\task_2\\test_case_data", es)
...
if __name__ == "_main_":
    ...
    csv_directory = "C:\\Users\\User\\AinurKurakbaeva\\DataAnalytics\\inf_428_hw_1\\task_2\\test_case_data"
    # csv_directory = "C:\\Users\\User\\AinurKurakbaeva\\DataAnalytics\\inf_428_hw_1\\task_2\\threat_scores.csv"
